...
import com.project.pricing.config.JwtService;
import com.project.pricing.exception.ResourceNotFoundException;
import com.project.pricing.token.Token;
import com.project.pricing.token.TokenRepository;
import com.project.pricing.token.TokenState;
import com.project.pricing.token.TokenType;
import com.project.pricing.model.Role;
import com.project.pricing.model.User;
import com.project.pricing.repository.UserRepository;
...
public class AuthenticationService {
        ...
        public ResponseEntity<AuthenticationResponse> updateUserDetails(String email, UpdateUserRequest request) {
                User user = repository.findByEmail(email)
                                .orElseThrow(() -> new ResourceNotFoundException("User not found"));
